...
namespace HCore.API.Controllers.Admin
{
    ...
    public class SysMenusController : ControllerBase
    {
        ...
        [HttpPost]
        [HCoreAuthorize(HCorePermissions.Prefix.Administration, HCorePermissions.Page.SysMenu, HCorePermissions.Action.Create)]
        ...
        [HttpGet("{id}")]
        [HCoreAuthorize(HCorePermissions.Prefix.Administration, HCorePermissions.Page.SysMenu, HCorePermissions.Action.View)]
        ...
        [HttpPut("{id}")]
        [HCoreAuthorize(HCorePermissions.Prefix.Administration, HCorePermissions.Page.SysMenu, HCorePermissions.Action.Update)]
        ...
        [HttpDelete("{id}")]
        [HCoreAuthorize(HCorePermissions.Prefix.Administration, HCorePermissions.Page.SysMenu, HCorePermissions.Action.Delete)]
        ...
        [HttpGet("all")]
        [HCoreAuthorize(HCorePermissions.Prefix.Administration, HCorePermissions.Page.SysMenu, HCorePermissions.Action.Search)]
